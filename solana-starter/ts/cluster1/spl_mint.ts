...
// Mint address
const mint = new PublicKey("9DqC3ZGUP847tUE83awF2WeTyw7wM93WtEojnHDKJR2T");
...
(async () => {
    try {
        ...
        // Mint to ATA
        const mintTx = await mintTo(connection, keypair, mint, (await ata).address, keypair.publicKey, 10000)
